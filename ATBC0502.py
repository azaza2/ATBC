...
access = "6PwBHITPpgeLxgj8wUIM6gHzDiixWltrISVyPS7v"          # 본인 값으로 변경
secret = "UmU3piFu0xJ7xUB3MkVt5BbdVt6DvG0dJ7TZVfVA"          # 본인 값으로 변경
    ...
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            if sell_price < current_price:
                btc = get_balance("BTC")
                if btc > 0.00008:
                    sell_reuslt = upbit.sell_market_order("KRW-BTC", btc*0.9995) 
